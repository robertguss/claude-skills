...
1. Identify the core challenge your book faces
2. Find frameworks that address that challenge
3. Test-fit 2-3 candidates against your content and reader
4. Select and adapt—most successful books combine frameworks
5. Document your rationale in the Architecture Document
...
4. Case study 3 (reveals facet C, pattern emerges)
5. Additional cases as needed
...
4. Third layer (profound implications)
...
5. How it works
6. How to implement
7. What to expect / maintaining results
...
4. The crisis or turning point
5. Breakthrough and insight
...
4. Continue for each major myth
...
4. The cost of not addressing it
5. Treatment options / approaches
...
4. Module B (standalone)
5. Continue with modules
6. Integration chapter (how pieces connect)
...
4. Synthesis (the higher truth that integrates both)

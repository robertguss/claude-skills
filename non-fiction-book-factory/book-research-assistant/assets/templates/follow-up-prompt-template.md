...
**Validation Verdict:** Needs More

**Specific Deficiencies:**

[List exactly what was insufficient. Be precise. E.g.:]
...
- [ ] Specificity gap: [Examples too general—need named, concrete cases]
- [ ] Conflict unresolved: [Claude and Gemini disagreed on X—need clarification]
...
Structure your follow-up response as:

### Additional Findings

New material that addresses the specific deficiencies identified above.
...
- How it addresses the identified gap

### Integration Notes

How these new findings connect to or modify the original research findings.

...
2. **What's the specific promise or contract this opening sets?**
3. **How does this opening meet the reader's entry state?**
4. **What tone does this establish?**
5. **What should the ghostwriter avoid?** (Anti-patterns, wrong notes, traps)
6. **Are there specific hooks, images, or phrases to consider?**
